...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border/70 bg-background/85 backdrop-blur-md">
      <div className="mx-auto flex h-20 max-w-7xl items-center justify-between px-4 min-[360px]:px-6 lg:px-5 xl:px-8">
        ...
        <div className="hidden items-center gap-1 lg:flex xl:gap-2 2xl:gap-3">
          <LocaleSwitcher />
          <ThemeToggle />
          <Button href="/donate" size="sm" variant="accent" className="lg:px-2.5 lg:text-[13px] xl:px-4 xl:text-sm">
            {t("support")}
